...
public enum EnumCountryCode implements Serializable {
   ...
   /*
    * <a href="http://en.wikipedia.org/wiki/Bosnia_and_Herzegovina">Bosnia
    * and Herzegovina</a>
    */
   ...
   FJ("Fiji", "FJI", 242),
   /*
    * <a href="http://en.wikipedia.org/wiki/Falkland_Islands">Falkland
    * Islands (Malvinas)</a>
    */
   ...
   KM("Comoros", "COM", 174),
   /*
    * <a href="http://en.wikipedia.org/wiki/Saint_Kitts_and_Nevis">Saint
    * Kitts and Nevis</a>
    */
   ...
   /*
    * <a
    * href="http://en.wikipedia.org/wiki/Collectivity_of_Saint_Martin">Saint
   ...
   /*
    * <a
    * href="http://en.wikipedia.org/wiki/Northern_Mariana_Islands">Northern
    * Mariana Islands</a>
    */
   ...
   /*
    * <a href="http://en.wikipedia.org/wiki/Turks_and_Caicos_Islands">Turks
    ...
    */
   EU("European Union", "EUR", 901),
   ;

   private static final Map<String, EnumCountryCode> alpha3Map = new HashMap<>();

   private static final Map<Integer, EnumCountryCode> numericMap = new HashMap<>();
   ...
   /**
    * Atribuim valorile la apelarea "clasei".
    *
    * @param name
    * @param alpha3
    * @param numeric
    */
   private EnumCountryCode(String name, String alpha3, int numeric) {
      this.name = name;
      this.alpha3 = alpha3;
    ...
    *             <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" >alpha
    *             -2</a> or
    *             <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >alpha
    *             -3</a> code.
    * @return A CountryCode instance, or null if not found.
    */
   public static EnumCountryCode getByCode(String code) {
      if (code == null) {
         return null;
      }
      switch (code.length()) {
    ...
    *
    * @param code An
    *             <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric" >ISO
    *             3166-1 numeric</a> code.
    * @return A CountryCode instance, or null if not found.
    */
   public static EnumCountryCode getByCode(int code) {
      return numericMap.get(code);
   }

   private static EnumCountryCode getByAlpha2Code(String code) {
      try {
         return Enum.valueOf(EnumCountryCode.class, code);
      } catch (IllegalArgumentException e) {
         return null;
      }
   }

   private static EnumCountryCode getByAlpha3Code(String code) {
    ...
    * @return country or RO as default
    */
   public static EnumCountryCode getByName(String name) {
      EnumCountryCode[] values = values();
      for (EnumCountryCode ecn : values) {
         String mname = ecn.getName();
         name = StringUtils.trim(name);
         if (StringUtils.equalsIgnoreCase(mname, name)) {
            return ecn;
         }
      }
      return RO;
